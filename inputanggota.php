...
<main role="main" class="col-sm-9 ml-sm-auto col-md-10 pt-3">
          <h1 style="border-bottom: 4px solid #eee; padding-bottom: 9px">Daftar Anggota</h1><br>
  ...
  <div class="form-row">
    ...
    <div class="form-group col-md-6">
      ...
      <span class="input-group-addon"> 
      <input type="password" class="form-control" id="validationDefault01" name="sandi" placeholder="Password" required>
      </span>
      <div class="invalid-feedback">
