...
<main role="main" class="col-sm-9 ml-sm-auto col-md-10 pt-3">
          <h1 style="border-bottom: 4px solid #eee; padding-bottom: 9px">Simpanan</h1><br>

<form class="container" id="needs-validation" novalidate  method="post" action="formsimpanan.php">
  <div class="row">
  ...
  <div class="row">
    <div class="col-md-6 mb-3">
      <label for="validationCustom03">Besar Simpanan</label>
      <span class="input-group-addon">Rp &nbsp;
      <input type="text" class="form-control" id="validationCustom03" name="besarsimp" required>
      </span>
      <div class="invalid-feedback">
        Harap cantumkan besar simpanan.
      </div>
    </div>
    <div class="col-md-3 mb-3">
      
      <label for="validationCustom04">Tanggal Simpanan</label>
      <span class="input-group-addon">
      <input type="date" class="form-control" id="validationCustom04" name="tglsimp" placeholder="dd/mm/yy" required>
      </span>
      <div class="invalid-feedback">
...
$result = mysqli_query($connect, "SELECT * FROM formsimpanan");
  ?>
...
<table class="table">
  <thead class="thead-dark">
    <tr>
      ...
      <th scope="col" style="text-align: right;">Besar Simpanan</th>
      <th scope="col" style="text-align: center;">Tanggal Simpanan</th>
    </tr>
  </thead>
    ...
    <tbody>
       <tr>
         <td><?php echo $row['nim']; ?></td>
          ...
          <td style="text-align: right;"><?php echo $row['besarsimpanan']; ?></td>
          <td style="text-align: center;"><?php echo $row['tglsimpanan']; ?></td>
       </tr>
    </tbody>
<?php
  }
