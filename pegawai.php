...
$query = "SELECT nama,jabatan,nim,jurusan FROM formpegawai";

$result = mysqli_query($connect, $query);
?>

<main role="main" class="col-md-10 ml-sm-auto col-md-10 pt-3">
          <h1 style="border-bottom: 4px solid #eee; padding-bottom: 9px">Pegawai</h1><br>
          <section style="border-bottom: 2px solid #eee; padding-bottom: 9px;" class="row text-center placeholders" method="post" action="pegawai.php">
            <div class="col-6 col-sm-3 placeholder">
              <a href="inputpegawai.php"><img src="green.png" width="150" height="150" class="img-fluid rounded-circle" alt="Generic placeholder thumbnail"></a>
              <h4>Tambah Pegawai</h4>
              <span class="text-muted"></span>
            </div>

            <div class="col-6 col-sm-3 placeholder">
            <a href="ubahpegawai.php"><img src="update.png" width="150" height="150" class="img-fluid rounded-circle" alt="Generic placeholder thumbnail"></a>
              <h4>Ubah Pegawai</h4>
              <span class="text-muted"></span>
            </div>
            ...
            <section class="row text-center placeholders" method="post" action="pegawai.php">
<?php
